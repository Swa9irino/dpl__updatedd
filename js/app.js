...
const app={
    ...
    data(){
        return{
            ...
            productss: [
                {id:1,img:'bicycle2.png',name:"MSI GeForce GTX 1660 SUPER Gaming", price:20000 ,views:31,category:"powerbank"},
                {id:2,img:'bicycle2.png',name:"MSI GeForce GTX ", price:30000 ,views:1,category:"powerbank"},
                {id:3,img:'iphone13.png',name:"iphone13",price:50000 ,views:21 ,category:"phone"},
                {id:4,img:'bicycle2.png',name:"Велосипед AltairAL 27.5 V FR", price:6000,views:211,category:"phone"},
